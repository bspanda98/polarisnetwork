Contributing to Polarisnetwork Core
==================================

The Polarisnetwork Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Polarisnetwork Core project, and is not to be
confused with overall Polarisnetwork Network Protocol consensus changes.

Whether a pull request is merged into Polarisnetwork Core rests with the project merge
...
Patches that change Polarisnetwork consensus rules are considerably more involved than
...
Where a patch set proposes to change the Polarisnetwork consensus, it must have been
...
The project leader is the release manager for each Polarisnetwork Core release.
