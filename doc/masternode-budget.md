...
Polarisnetwork now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<polarisnetwork_address\> \<monthly_payment_polarisnetwork\> [use_ix(true|false)]
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<polarisnetwork_address\> \<monthly_payment_polarisnetwork\> \<collateral_hash\>
 ...
 * vote-many          - Vote on a Polarisnetwork initiative
 * vote-alias         - Vote on a Polarisnetwork initiative
 * vote               - Vote on a Polarisnetwork initiative/budget
