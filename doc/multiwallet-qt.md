...
In order to support loading of multiple wallets in polarisnetwork-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is polarisnetwork.cpp.
...
Changes to polarisnetwork.cpp
----------------------
polarisnetwork.cpp is the entry point into polarisnetwork-qt, and as such, will require some minor modifications to provide hooks for
