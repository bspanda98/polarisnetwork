...
This mechanism has been integrated into Bitcore-Node-Polarisnetwork which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/polarisnetwork/insight-api-polarisnetwork#web-socket-api](https://github.com/polarisnetwork/insight-api-polarisnetwork#web-socket-api)
* API: [https://github.com/polarisnetwork/insight-api-polarisnetwork#swifttx-transactions](https://github.com/polarisnetwork/insight-api-polarisnetwork#swifttx-transactions)
...
By default, the Polarisnetwork Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Polarisnetwork Core daemon:
