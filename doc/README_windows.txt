...
Intro
-----
Polarisnetwork (POL) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. Polarisnetwork utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run polarisnetwork-qt.exe.

Polarisnetwork Core is the original Polarisnetwork client and it builds the backbone of the network.
However, it downloads and stores the entire history of Polarisnetwork transactions;
