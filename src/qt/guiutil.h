...
/** Utility functions used by the Polarisnetwork Qt UI.
 */
namespace GUIUtil
{
...
// Parse "polarisnetwork:" URI into recipient object, return true on successful parsing
