...
#define URI_SCHEME "polarisnetwork"
...
{
    // return if URI is not valid or is no polarisnetwork: URI
...
{
    // Convert polarisnetwork:// to polarisnetwork:
    //
    //    Cannot handle this later, because polarisnetwork:// will cause Qt to see the part after // as host,
...
void openConfigfile()
{
    ...
    /* Open polarisnetwork.conf with the associated application */
...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "Polarisnetwork.lnk";
}

bool GetStartOnSystemStartup()
{
    // check for Polarisnetwork.lnk
...
{
    return GetAutostartDir() / "polarisnetwork.desktop";
}
...
bool SetStartOnSystemStartup(bool fAutoStart)
{
    if (!fAutoStart)
        ...
        if (!optionFile.good())
            return false;
        // Write a polarisnetwork.desktop file to the autostart directory:
        optionFile << "[Desktop Entry]\n";
        optionFile << "Type=Application\n";
        optionFile << "Name=Polarisnetwork\n";
...
LSSharedFileListItemRef findStartupItemInList(LSSharedFileListRef list, CFURLRef findUrl)
{
    // loop through the list of startup items and try to find the polarisnetwork app
...
bool SetStartOnSystemStartup(bool fAutoStart)
{
    ...
    if (fAutoStart && !foundItem) {
        // add polarisnetwork app to startup item list
