...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Polarisnetwork Core"),
     ...
     * override -datadir in the polarisnetwork.conf file in the default data directory
     * (to be consistent with polarisnetworkd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
