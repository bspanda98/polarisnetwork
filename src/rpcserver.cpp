...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Polarisnetwork server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Polarisnetwork server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Polarisnetwork features */
        {"polarisnetwork", "masternode", &masternode, true, true, false},
        {"polarisnetwork", "listmasternodes", &listmasternodes, true, true, false},
        {"polarisnetwork", "getmasternodecount", &getmasternodecount, true, true, false},
        {"polarisnetwork", "masternodeconnect", &masternodeconnect, true, true, false},
        {"polarisnetwork", "masternodecurrent", &masternodecurrent, true, true, false},
        {"polarisnetwork", "masternodedebug", &masternodedebug, true, true, false},
        {"polarisnetwork", "startmasternode", &startmasternode, true, true, false},
        {"polarisnetwork", "createmasternodekey", &createmasternodekey, true, true, false},
        {"polarisnetwork", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"polarisnetwork", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"polarisnetwork", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"polarisnetwork", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"polarisnetwork", "getmasternodescores", &getmasternodescores, true, true, false},
        {"polarisnetwork", "mnbudget", &mnbudget, true, true, false},
        {"polarisnetwork", "preparebudget", &preparebudget, true, true, false},
        {"polarisnetwork", "submitbudget", &submitbudget, true, true, false},
        {"polarisnetwork", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"polarisnetwork", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"polarisnetwork", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"polarisnetwork", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"polarisnetwork", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"polarisnetwork", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"polarisnetwork", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"polarisnetwork", "checkbudgets", &checkbudgets, true, true, false},
        {"polarisnetwork", "mnsync", &mnsync, true, true, false},
        {"polarisnetwork", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> polarisnetwork-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:1998/\n";
}
