...
int nStakeTargetSpacing = 60; // Polarisnetwork: 1 minute blocks during POS (block 201+)
...
{
    // Polarisnetwork will hash in the transaction hash and the index number in order to make sure each hash is unique
