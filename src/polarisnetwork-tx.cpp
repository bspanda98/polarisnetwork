...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Polarisnetwork Core polarisnetwork-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  polarisnetwork-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded polarisnetwork transaction") + "\n" +
                               "  polarisnetwork-tx [options] -create [commands]   " + _("Create hex-encoded polarisnetwork transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded polarisnetwork transaction
