/* src/config/polarisnetwork-config.h.  Generated from polarisnetwork-config.h.in by configure.  */
/* src/config/polarisnetwork-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_NAME "Polarisnetwork Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Polarisnetwork Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "polarisnetwork"
